		...
		<div id="breadcrumbs" style="margin-bottom: 0">
		    ...
		    <ul class="breadcrumb">
		     ...
		     <?php if(isset($category) && $category): 
		     	if(isset($cateCheck)){
		     		$link = action('SiteController@news',['slug'=>$category->slug]);
		     	}else{
		     	...
		     	<?php if($module->name == 'event'): ?>
		      		...
		      		<?php else: ?>
		      			...
		      			<?php else: ?>
		      				<?php $link = action('SiteController@news',['slug'=>'']) ?>
		      			<?php endif;?>	
		      		<?php endif;?>	
		      		<?php
	...
	<div class="container"> 
		...
		<div class=" list slide3-arr owl-carousel top-arrows">
			@foreach($relateds as $item)
				<div class="list_item ">
					<a href="{{action('SiteController@life',$item->slug)}}" class="list_img thumbCover_60">
					...
					<div class="list_text">
						...
						<a href="{{action('SiteController@life',$item->slug)}}">
