...
<section class="top-page bg-white">
		...
		<div id="breadcrumbs" style="margin-bottom: 0">
		    ...
		    <ul class="breadcrumb">
		      ...
		      <li><a href="{{route('huongdandinhcu')}}">{{$module->title}}</a></li>
...
<section class="row-section u008 list5 ">
	<div class="container"> 
		...
		<div class=" list slide3-arr owl-carousel top-arrows">
			...
			<?php $site = 'SiteController@hddcDetail'; ?>
				<div class="list_item ">
					<a href="{{action($site,['slug'=>$item->getSlug()])}}" class="list_img thumbCover_60">


						@if($item->content_image != '')
							<img class="img-lazy" data-src="{{URL::to('/')}}/uploads/images/contents/{{$item->content_image }}" alt="" /> 
						@else
							<img class="img-lazy" data-src="{{$item->getImage('thumbnail')}}" alt="" /> 
						@endif
					</a>
					<div class="list_text">
