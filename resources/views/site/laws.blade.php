		...
		<div class=" list row">
			...
			<div class="col-md-4 col-sm-6 col-xs-6 col-xxs-12">
				<div class="list_item  wow">
					<a href="{{action('SiteController@lawsDetail',['slug'=>$data->slug])}}" class="list_img thumbCover_60">
						<img class="img-lazy" data-src="{{$data->imageUrl($data->getImage('thumbnail'),360,216,100)}}" alt="" />
					</a>
					<div class="list_text">
						<div class="list_small"></div>
						<a href="{{action('SiteController@lawsDetail',['slug'=>$data->slug])}}" class="list_title">{{ $data->title }}</a>
