	...
	<div class="chart-div">	
		...
		<amp-carousel height="458" width="345" layout="responsive" type="slides">
			@foreach($projects as $project)
				<div>
				  	<a href="{{action('AmpController@projectDetail',['slug'=>$project->getSlug()])}}" class="list_item wow fadeInUpS">
	...
	<div class="chart-div"> 
		...
		<amp-carousel width="384" height="215" layout="responsive" type="slides" autoplay delay="2000">
		  @foreach($event as $key => $ev)
			<div class="snip1543">
		  	<a href="{{action('AmpController@eventsDetail',['slug'=>$ev->getSlug()])}}" class="desc">
        ...
        <div class="row">
            <div class="col-md-6 list12">
                <div class="list">
                	...
                	?>
                    <div class="list_item">
                        <a href="{{action('AmpController@newsDetail',['slug'=>$data->getSlug()])}}" class="list_img thumbCover_86">
                            <amp-img src="{{$img}}" @if($i == 1) width="384" height="332" @else width="64" height="36" @endif layout="responsive" alt=""></amp-img>
                        </a>
                        <div class="list_text">
                            <a href="{{action('AmpController@newsDetail',['slug'=>$data->getSlug()])}}" class="list_title">{{ stripslashes($data->title) }}</a>
                            <p class="list_desc">
                            	<?php 
