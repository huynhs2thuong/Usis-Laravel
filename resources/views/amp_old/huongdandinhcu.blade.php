		...
		<div class=" list row">
			...
			<div class="col-md-4 col-sm-6 col-xs-6 col-xxs-12">
				<div class="list_item  wow">
					<a href="{{action('AmpController@hddcDetail',$data->getSlug())}}" class="list_img thumbCover_60">
						...
						@else
							@if($data->content_image != '')
								...
								<amp-img src="{{$data->imageUrl($url,360,216,100)}}" width="384" height="230" layout="responsive" alt="" /> 
							@else
								<amp-img src="{{$data->imageUrl($data->getImage('thumbnail'),360,216,100)}}" width="384" height="230" layout="responsive" alt="" /> 
							@endif
						@endif
					...
					<div class="list_text">
						...
						<a href="{{action('AmpController@hddcDetail',$data->getSlug())}}" class="list_title">{{ $data->title }}</a>
