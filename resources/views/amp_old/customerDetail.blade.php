	...
	<div class="container"> 
		...
		<div class=" list slide3-arr top-arrows owl-carousel">
			@foreach($others as $data)
				<div class="list_item ">
					<a href="{{ action('SiteController@customerDetail',['slug'=>$data->getSlug()]) }}" class="list_img">
					...
					<div class="list_text">
						<a href="{{ action('SiteController@customerDetail',['slug'=>$data->getSlug()]) }}" class="list_title">{{ $data->title }}</a>
