				...
				@foreach($posts as $data)
					<div class="col-md-4 col-sm-6 col-xs-6 col-xxs-12">
						<div class="list_item  wow">
							<a href="{{action('AmpController@hdAncuChitiet',['slug'=>$data->slug,'suffix'=>'.html'])}}" class="list_img thumbCover_60">
							...
							<div class="list_text">
								<a href="{{action('AmpController@hdAncuChitiet',['slug'=>$data->slug,'suffix'=>'.html'])}}" class="list_title">
