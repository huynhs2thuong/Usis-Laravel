    	...
    	<div class="block2">
	    	<div class="row block">
	    		<div class="col-md-6 block_img">
	    			<a href="{{route('eventsnewsDetailamp',['slug'=>$stickyEvent->slug,'suffix'=>'.html'])}}" title="{{$stickyEvent->title}}">
						<amp-img src="{{$stickyEvent->imageUrl($url,570,296,80)}}" alt="" width="472" height="300" layout="responsive" /> 
					</a>
					<div class="inner">
						<div class="inner2">
						<h4 class="text-1"></h4>
						<h2 class="text-2"><a href="{{route('eventsnewsDetailamp',['slug'=>$stickyEvent->slug,'suffix'=>'.html'])}}" title="{{$stickyEvent->title}}"> {{$stickyEvent->title}}	</a></h2>
						</div>
					</div>
	    		</div>
	    		<div class="col-md-6 block_text">
					...
					<a href="{{action('AmpController@eventsDetail',['slug'=>$stickyEvent->slug,'suffix'=>'.html'])}}" class="btn  ">@lang('page.menu.xem_them')</a>
	    		</div>
	    	</div>
		</div>	    	
    </div> 
