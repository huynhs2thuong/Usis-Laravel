		...
		<div class="container">
			...
			<div class="list row">
				...
				<div class="col-md-4 col-sm-6 ">
					<div class="list_item ">
						<a class="list_img" href="{{ action('AmpController@customerDetail',['slug'=>$cust->getSlug(),'suffix'=>'.html']) }}">
						...
						<div class="list_text">
							<a class="list_title" href="{{ action('AmpController@customerDetail',['slug'=>$cust->getSlug(),'suffix'=>'.html']) }}">
								{{$cust->title }} 
							</a>
