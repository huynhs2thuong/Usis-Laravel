...
@if($page->slug !== 'dich-vu-an-cu')
    <section class="row-section list4 pb-0 bg-white wow">
		...
		<amp-carousel height="308" layout="fixed-height" type="slides" class="list slide3-arr owl-carousel">
			...
			<a href="{{ action('AmpController@projectDetail',['slug'=>$project->slug,'suffix'=>'.html']) }}" class="list_item">
	...
	<div class="container"> 
		...
		<div class=" list row">
			...
			<div class="col-md-4 col-sm-6 col-xs-6 col-xs-12">
				<div class="list_item ">
					<a href="{{ action('AmpController@projectDetail',['slug'=>$project->slug,'suffix'=>'.html']) }}" class="list_img thumbCover_75">
						<amp-img src="{{$project->getImage()}}" alt="" width="343" height="308" layout="responsive"/>
					</a>
					<div class="list_text">
						<a href="{{ action('AmpController@projectDetail',['slug'=>$project->slug,'suffix'=>'.html']) }}" class="list_title">{{$project->title}}</a>
						<div class="list_position">{{$project->excerpt}}</div>
					</div>
				</div> 
			</div>
