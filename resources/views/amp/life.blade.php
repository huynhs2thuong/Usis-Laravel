				...
				<div class=" list row">
					...
					<div class="col-md-4 col-sm-6 col-xs-6 col-xxs-12">
						<div class="list_item  wow">
							...
							<div class="list_text">
								<a href="{{action('AmpController@lifeDetail',['slug'=>$data->getSlug(),'suffix'=>'.html'])}}" class="list_title">
									@if(isset($data->title))
				...
				<div class="widget widget-hotnews wow">
					...
					<div class="widget-content">
						<div class="list7">
							<div class="list">
								@foreach($hots as $hot)
									<a href="{{action('AmpController@lifeDetail',['slug'=>$hot->slug,'suffix'=>'.html'])}}"  class="list_item ">
