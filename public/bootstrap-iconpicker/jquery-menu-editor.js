function MenuEditor(l, t) {
    ...
    i.sortableLists(r.listOptions), c.on("change", function(e) {
        ...
        if (null !== e) {
            ...
            }), e.children().children("i").removeClass(s).addClass(e.data("icon")), e.find("span.txt").first().text(e.data("vi")), d()
        }
    }, this.add = function() {
        var e = {};
        a.find(".item-menu").each(function() {
            ...
            var t = function d(e, s) {
                ...
                return $.each(e, function(e, s) {
                    ...
                    var i = $("<div>").css("overflow", "auto"),
                        r = $("<i>").addClass(s.icon),
                        a = $("<span>").addClass("txt").append(s.vi).css("margin-right", "5px"),
                        c = f();
