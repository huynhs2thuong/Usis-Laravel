function MenuEditor(l, t) {
    var i = $("#" + l),
        r = {
            ...
            labelShow: '<i class="fas fa-eye clickable"></i>',
            labelHide: '<i class="fas fa-eye-slash clickable"></i>',
            labelRemove: '<i class="fas fa-trash-alt clickable"></i>',
            textConfirmDelete: "This item will be deleted. Are you sure?",
            textHide: "Bạn muốn ẩn mục này?",
            textLine: "Bạn muốn hiện mục này?",
            iconPicker: {
                cols: 4,
                rows: 4,
                footer: !1,
    ...
    function f(a) {
        ...
        if(a != 1){
            var w = p({
                    classCss: "btn btn-primary btn-sm btnShow",
                    text: r.labelShow
            });
        }else{
            var w = p({
                    classCss: "btn btn-primary btn-sm btnHide",
                    text: r.labelHide
            });
        }
        var s = p({
        ...
        return e.append(l).append(n).append(i).append(o).append(s).append(w).append(t), e
    }
    ...
    }), i.on("click", ".btnShow",function(e){
        if (e.preventDefault(), confirm(r.textLine)) {
            var m = {'hidden' : '1'};
            var s = $(this).closest("li").data(m);
            //$(this).closest("li").addClass("eye_hide").css("opacity","0.5");
            //$(this).closest("li").find(".fa-eye").toggleClass("fa-eye-slash");
            $(this).closest("li").find(".fa-eye").removeClass("fa-eye").addClass("fa-eye-slash");
            $(this).closest("li").find(this).removeClass("btnShow").addClass("btnHide");
           
        } MenuEditor.updateButtons(i)
    }), i.on("click", ".btnHide",function(e){
        if (e.preventDefault(), confirm(r.textHide)) {
            var m = {'hidden' : '0'};
            var s = $(this).closest("li").data(m);
            //$(this).closest("li").addClass("eye_hide").css("opacity","1");
            //$(this).closest("li").find(".fa-eye-slash").toggleClass("fa-eye");
            $(this).closest("li").find(".fa-eye-slash").removeClass("fa-eye-slash").addClass("fa-eye");
            $(this).closest("li").find(this).removeClass("btnHide").addClass("btnShow");
