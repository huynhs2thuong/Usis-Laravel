			...
			<body>
				<div id="content">
						...
						<table id="sitemap" cellpadding="3">
							...
							<xsl:for-each select="sitemap:sitemapindex/sitemap:sitemap">
								<xsl:variable name="sitemapURL">
									<xsl:value-of select="sitemap:link"/>
								</xsl:variable>
								<tr>
									<td>
					...
					<xsl:if test="count(sitemap:sitemapindex/sitemap:sitemap) &lt; 1">
						...
						<p class="expl"><a href="/en/sitemap.xml">↑ Sitemap Index</a></p>
						<table id="sitemap" cellpadding="3">
							<thead>
								<tr>
									<th width="70%">URL</th>
									...
									<th title="Last Modification Time" width="10%">Released</th>
								</tr>
							</thead>
							<tbody>
								...
								<xsl:for-each select="sitemap:urlset/sitemap:url">
									<tr>
										...
										<td>
											<xsl:value-of select="concat(substring(sitemap:released,0,11),concat(' ', substring(sitemap:released,12,5)))"/>
										</td>
									</tr>
								</xsl:for-each>
							</tbody>
